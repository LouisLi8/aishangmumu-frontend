  ...
  if (response.status === 200) {
    if (response.data && response.data.code) {
      switch(response.data.code) {
        ...
        case 'app_401': app.$message.error(response.data.message); return Promise.reject(); break;
        case 'app_402': app.$message.error(response.data.message); break;
        case 'app_403': app.$message.error(response.data.message); break;
        case 'app_404': app.$message.error(response.data.message); break;
        case 'app_405': app.$message.error(response.data.message); break;
        case 'app_406': app.$message.error(response.data.message); break;
        case 'app_413': app.$message.error(response.data.message); break;
        case 'sso_401': app.$message.error(response.data.message); break;
        case 'sso_402': app.$message.error(response.data.message); break;
        case 'sso_403': app.$message.error(response.data.message); break;
        case 'sso_404': app.$message.error(response.data.message); break;
        case 'sso_413': app.$message.error(response.data.message); break;
